 ...
 * Falls back to simple NEXT_PUBLIC_FIREBASE_* vars for convenience.
 */
const UAT_CONFIG: FirebaseConfig = {
    apiKey: process.env.NEXT_PUBLIC_FIREBASE_UAT_API_KEY || process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "",
    authDomain: process.env.NEXT_PUBLIC_FIREBASE_UAT_AUTH_DOMAIN || process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "",
    projectId: process.env.NEXT_PUBLIC_FIREBASE_UAT_PROJECT_ID || process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "",
    storageBucket: process.env.NEXT_PUBLIC_FIREBASE_UAT_STORAGE_BUCKET || process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "",
    messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_UAT_MESSAGING_SENDER_ID || process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "",
    appId: process.env.NEXT_PUBLIC_FIREBASE_UAT_APP_ID || process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "",
...
export const verifyEnvironmentConfiguration = (): void => {
  ...
  if (!isFirebaseConfigured()) {
    console.warn(
      'Firebase is not configured. Set environment variables from .env.example. ' +
